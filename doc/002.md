...
2. Click the <span style="color:white;background-color:blue">**Push app**</span> button.

3. Once the **quotation_1_0_flogo_app** app is running, hover over the **Endpoint** link, and select **View and Test** from the menu

4. Test the **quotation_1_0_flogo_app** app by filling out a value in the required fields, and clicking on the **Try it out!** button.
